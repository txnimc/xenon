...
/**
 * This event is fired by Xenon to allow mods to add their own custom geometry to chunks as they are being meshed.
 *
 ...
 * work with Xenon as it doesn't use vanilla's chunk task classes.
 *
