...
import toni.xenon.extras.ExtrasConfig.FPSDisplayGravity;
import toni.xenon.extras.ExtrasConfig.FPSDisplayMode;
import toni.xenon.extras.ExtrasConfig.FPSDisplaySystemMode;
import toni.xenon.extras.ExtrasConfig.FullScreenMode;
...
public class ExtrasOptions {
    ...
    public static void setFPSOptions(List<OptionGroup> groups, SodiumOptionsStorage sodiumOpts) {
        ...
        for (int i = 0; i < components.length; i++) {
            components[i] = Component.translatable("xenon.extras.options.displayfps.gravity." + FPSDisplayGravity.values()[i].name().toLowerCase());
        }
